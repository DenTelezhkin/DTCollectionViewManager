...
test-iOS:
	set -o pipefail && xcodebuild -project DTCollectionViewManager.xcodeproj -scheme DTCollectionViewManager-iOS -destination "name=iPhone 6 Plus" -enableCodeCoverage YES test -configuration "Release" | xcpretty -ct
